...
In Unity Hub, select the "ADD" button, then browse to the cloned repository on your machine.<br>
Once the project is added to Unity Hub, you can open it by double-clicking the project in Unity Hub.<br>
Once in Unity, select the right-facing arrow at the top-center of the screen to launch the game.<br>